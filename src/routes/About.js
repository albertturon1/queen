  ...
  return (
    <div className="pt-10 w-full flex flex-col items-center">
      <SectionWrapper title='Historia zespołu'>
        <img src={'https://rockpasta.com/wp-content/uploads/2020/09/2020-09-08-15_53_11-queenband-hashtag-on-Instagram-%E2%80%A2-Photos-and-Videos.png'} className="float-left w-96 object-contain pr-5 pb-5" />
        <p className="text-justify">Queen to brytyjski zespół rockowy założony w 1970 roku przez swojego wokalistę, Freddiego Mercury'ego, Briana Maya na gitarze, Rogera Taylora na perkusji i Johna Deacona na basie.
          ...
          <img src={'https://rockcelebrities.net/wp-content/uploads/2022/02/queen-playing-together.jpg'} className="float-right w-96 object-contain pl-5 pb-5" />
          ...
          <img src={'https://cdn.mos.cms.futurecdn.net/RVRUGmSinpf6XQADiez8C-1200-80.jpg'} className="float-left w-96 object-contain pr-5 pb-5" />
          ...
          W 1987 roku para Mercury'ego, Jim Hutton, ogłosiła, że ​​piosenkarz ma AIDS, chociaż wszyscy członkowie zespołu temu zaprzeczali. Jednak w 1991 roku Mercury powiedział w oświadczeniu, że ma chorobę. W tym samym tekście prosił o wsparcie swojej publiczności i przyjaciół w walce z chorobą. Mimo to dwa dni później, 24 listopada, Freddie Mercury zmarł w wieku zaledwie 45 lat.<br></br><br></br>
        ...
        <a className="text-blue-600" href="https://history-biography.com/history-of-queen/" target="_blank">Tekst przetłumaczony ze strony: https://history-biography.com/history-of-queen/</a>
